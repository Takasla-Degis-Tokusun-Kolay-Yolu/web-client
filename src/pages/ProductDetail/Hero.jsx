...
export const Hero = ({product}) => {
    return (
        <div className={'w-full bg-gradient-to-t from-brand-green to-brand-green/60 h-40 flex flex-row justify-center items-end mb-24'}>
            <div className={'w-40 h-40 bg-brand-green/50 rounded-lg -mb-20 overflow-hidden'}>
                <Image
                    ...
                    } alt={'avatar'} className={'rounded-lg border-8 border-brand-green mx-auto object-cover !w-40 !h-40'}/>
            </div>
        </div>
    )
};