    ...
    <>
        ...
        <div className="relative mt-20 pb-20" style={{ fontFamily: 'Urbanist' }}>
            <div className="flex items-center justify-center -space-x-2">
                ...
                <img loading="lazy" width="200" height="200" src={Avatar} alt="member photo" className="h-12 w-12 rounded-full object-cover" />
                <img loading="lazy" width="200" height="200" src={Avatar} alt="member photo" className="z-10 h-16 w-16 rounded-full object-cover" />
                <img loading="lazy" width="200" height="200" src={Avatar} alt="member photo" className="relative h-12 w-12 rounded-full object-cover" />
                <img loading="lazy" width="200" height="200" src={Avatar} alt="member photo" className="h-8 w-8 rounded-full object-cover" />
            </div>
            <div className="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12">
                <h1 className="text-center text-2xl font-bold text-gray-800  md:text-5xl">Deneyimlemek İster Misin?</h1>
