...
const About = () => (
    <>
        <div className="flex flex-col w-5/12 justify-center items-start ml-32 align-middle mt-44" style={{ fontFamily: 'Urbanist' }}>
        <img src={Avatar} alt="what is takasla" className='w-14' />
        <h1 className='text-5xl font-bold text-gray-700 mt-4'>Eşya Takası Artık Çok Kolay!</h1>
    ...
    <div className='mx-20 mt-12 grid divide-x divide-y divide-gray-100  overflow-hidden rounded-3xl border border-gray-100 text-gray-600  sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4'>
