const Hero = () => (
    <div className="flex flex-col justify-center items-center align-middle">
        ...
        <div className="mt-36 text-7xl z-[10] font-extrabold text-center text-gray-800" style={{ fontFamily: 'Urbanist' }}>Fazlalıklarından kurtul,<br /> eksiklerini tamamla: <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-green to-sky-600">Takasla</span></div>
        <div className="mt-12 text-2xl z-[10] text-center text-gray-600 md:mx-40">
        ...
        <div class="flex flex-wrap justify-center gap-6 mt-8">
                    <a href="#" class="relative flex h-12 w-full items-center justify-center px-8 before:absolute before:inset-0 before:rounded-full before:bg-brand-green/90 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max">
                        <span class="relative text-base font-semibold text-white ">Şimdi Dene</span>
                    </a>
                    <a href="#" class="relative flex h-12 w-full items-center justify-center px-8 before:absolute before:inset-0 before:rounded-full before:border before:border-transparent before:bg-brand-green/10 before:bg-gradient-to-b before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95  sm:w-max">
                        <span class="relative text-base font-semibold text-brand-green ">Takasla Nedir?</span>
                    </a>
                </div>
    </div>
)
