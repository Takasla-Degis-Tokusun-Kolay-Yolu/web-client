...
const Hero = ({ handleScrollClikToDown }) => (
  <div className="flex flex-col justify-center items-center align-middle">
    ...
    <div
      className="mt-20 md:mt-36 text-3xl md:text-7xl z-[10] font-extrabold text-center text-gray-800"
      style={{ fontFamily: "Urbanist" }}
    >
      Fazlalıklarından kurtul,
      <br /> eksiklerini tamamla:{" "}
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-green to-sky-600">
        Takasla
      </span>
    </div>
    <div className="mt-12 sm:text-xl md:text-2xl z-[10] text-center text-gray-600 mx-5 md:mx-10 lg:mx-40">
      Takasla, ihtiyaç duyduğunuz şeyleri elde etmenin en sürdürülebilir ve
      ekonomik yolunu sunuyor. Yeni bir ürün almak için para harcamak yerine,
      kullanmadığınız eşyalarınızı takas ederek diğer kullanıcılara fayda
      sağlayabilirsiniz.
    </div>
    <div className="flex flex-wrap justify-center gap-6 mt-8">
      ...
      <a
        href="#"
        onClick={handleScrollClikToDown}
      ...
      >
        <span className="relative text-base font-semibold text-brand-green ">
          Takasla Nedir?
        </span>
      </a>
    </div>
